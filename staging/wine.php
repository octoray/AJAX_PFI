...
<div class="block_6667" data-pfi-area="true" id="showmeee" style="<?php if ($_SERVER['HTTP_X_PFI_STATUS'] == 'PfiHybridSession') {echo "display:none";}else{echo "";}; ?>" >
    <div class="competition">
        <div id="comp-entry-area">
            ...
            <div class="btn1c" id="buttons1" data-pfi-button="true" data-pfi-button-id="a1" data-pfi-service-id="357" data-pfi-reference="<?php echo $out1;?>" data-pfi-content-url="/staging/landing.php" data-pfi-content-id="a_01">
                <span>September 15, 2015</span>
            </div>
            <div class="btn1c" id="buttons2" data-pfi-button="true" data-pfi-button-id="a2" data-pfi-service-id="357" data-pfi-reference="<?php echo $out2;?>" data-pfi-content-url="/staging/landing.php" data-pfi-content-id="a_02">
                <span>November 15, 2013</span>
            </div>
            <div class="btn1c" id="buttons3" data-pfi-button="true" data-pfi-button-id="a3" data-pfi-service-id="357" data-pfi-reference="<?php echo $out3;?>" data-pfi-content-url="/staging/landing.php" data-pfi-content-id="a_03">
