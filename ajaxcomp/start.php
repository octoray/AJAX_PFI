...
<div class="competition">
    <div id="comp-entry-area">
        ...
        <div class="btn" id="buttons1" data-pfi-button="true" data-pfi-button-id="a1" data-pfi-service-id="330" data-pfi-reference="<?php echo $out1;?>" data-pfi-content-url="/finish.php" data-pfi-content-id="a1">
            <span>10%</span>
        </div>
        <div class="btn" id="buttons2" data-pfi-button="true" data-pfi-button-id="a2" data-pfi-service-id="330" data-pfi-reference="<?php echo $out2;?>" data-pfi-content-url="/finish.php" data-pfi-content-id="a2">
            <span>20%</span>
        </div>
        <div class="btn" id="buttons3" data-pfi-button="true" data-pfi-button-id="a3" data-pfi-service-id="330" data-pfi-reference="<?php echo $out3;?>" data-pfi-content-url="/finish.php" data-pfi-content-id="a3">
            <span>5000%</span>
        </div>
    </div>
