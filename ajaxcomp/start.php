...
<div class="competition">
    <div id="comp-entry-area">
        ...
        <div class="btn" id="buttons1" data-pfi-button="wrong" data-pfi-button-id="a1" data-pfi-service-id="342" data-pfi-reference="<?php echo $out1;?>" data-pfi-content-url="/ajaxcomp/finish.php" data-pfi-content-id="a_01">
            <span>10%</span>
        </div>
        <div class="btn" id="buttons2" data-pfi-button="wrong" data-pfi-button-id="a2" data-pfi-service-id="342" data-pfi-reference="<?php echo $out2;?>" data-pfi-content-url="/ajaxcomp/finish.php" data-pfi-content-id="a_02">
            <span>20%</span>
        </div>
        <div class="btn" id="buttons3" data-pfi-button="correct" data-pfi-button-id="a3" data-pfi-service-id="342" data-pfi-reference="<?php echo $out3;?>" data-pfi-content-url="/ajaxcomp/finish.php" data-pfi-content-id="a_03">
            <span>5000%</span>
        </div>
    </div>
