...
// Perform queries
    ...
    mysqli_query($con,"INSERT INTO twitter_sent (header_key,msg,deliverychannel,twitterid,response_code,total_time_taken,namelookup_time,connect_time,response_json)VALUES('".$_POST['key_header']."','".$_POST['text']."','".$_POST['deliverychannel']."','".$_POST['twitterid']."','".$info['http_code']."','".$info['total_time']."','".$info['namelookup_time']."','".$info['connect_time']."','".$runy."')");
    mysqli_close($con);
}
...
<div id="chartContainer_header" align="center" class="chart1">
    <li><h1>IMIConnect Twitter POST</h1></li>
    <br>
    <form name="htmlform" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
        <table width="550px">
            ...
            <tr>
                <td valign="top">
                    <label for="ip">BODY (twitterid)</label>
                </td>
                <td valign="top">
                    <input  type="text" name="twitterid" maxlength="80" size="20" value="<?php if(isset($_POST['twitterid'])) {echo $_POST['twitterid'];}else{echo "xxxxxxxxxxxx";};?>">
                </td>
            </tr>
