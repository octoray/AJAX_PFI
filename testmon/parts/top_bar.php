...
<div class="navbar-header">
    ...
    <a id="logo" href="index.html" class="navbar-brand"><span class="fa fa-rocket"></span><span
            class="logo-text">PFI MONITOR</span><span style="display: none" class="logo-text-icon">PFI</span></a>
</div>
...
<ul class="nav navbar-nav    ">
    ...
    <li><a href="javascript:;" data-toggle="dropdown" class="dropdown-toggle">Layouts
        ...
        <ul class="dropdown-menu">
            <li><a href="layout_html/layout-left-sidebar.html">Left Sidebar</a></li>
            <li><a href="layout_html/layout-right-sidebar.html">Right Sidebar</a></li>
            <li><a href="layout_html/layout-left-sidebar-collapsed.html">Left Sidebar Collasped</a></li>
            <li><a href="layout_html/layout-right-sidebar-collapsed.html">Right Sidebar Collasped</a></li>
            ...
            <li><h4 class="mtn">Theme Colors</h4>
                <ul id="list-color" class="list-unstyled list-inline">
                    ...
                    <li data-color="pink-brown" data-hover="tooltip" title="Pink - Brown"
                        class="pink-brown"></li>
                    <li data-color="orange-blue" data-hover="tooltip" title="Green - Gray"
